...
// INSERE OS VALORES DIGITADOS NO FORM NA TABELA PRODUCAO
		session_start();
		// include ("conexao.php");
...
// --------- ATUALIZA TABELA STATUS  -------------------
		...
		//pega os valores atuais de status				
			...
			// echo "O valor de bat_barriga_aluguel  é ". var_dump($bat_barriga_aluguel);
			// echo "O valor de tbat_barriga_aluguel_v antes  é ". var_dump($tbat_barriga_aluguel_v);
		...
		//  echo "O valor de tbat_barriga_aluguel_v depois  é ". var_dump($tbat_barriga_aluguel_v);
   	...
   	<div class="container">
		...
		<div class="card">   <!---CARD ADICIONAR --->
			...
			<div class="card-body">		
					...
					<?php 					
					echo "O id_ciclo é : " .$_SESSION['max_id_ciclo'];
					?>
					...
					<!-- FIM CAMPOS AUX --->
						...
						<div class="row">
							...
							<div class="col-md-2">
								...
								<input type="number" min="0" class="form-control" name="ue2009p" id="ue2009p" placeholder ="0" value="0" onkeypress="$(this).mask('0000')" >
							</div>
							<div class="col-md-2 ">
								<label for="urna10"><h5>UE2010:</h5></label>
								<input type="number" min="0" class="form-control" name="ue2010p" id="ue2010p" value="0"  onkeypress="$(this).mask('0000')"  >
							</div>
							<div class="col-md-2 ">
								<label for="urna11"><h5>UE2011:</h5></label>
								<input type="number" min="0" class="form-control"  name="ue2011p" id="ue2011p" value="0" onkeypress="$(this).mask('0000')" >
							</div>
							<div class="col-md-2 ">
								<label for="urna13"><h5>UE2013:</h5></label>
								<input type="number" min="0" class="form-control" name="ue2013p" id="ue2013p" value="0" onkeypress="$(this).mask('0000')" >
							</div>
							<div class="col-md-2 ">
								<label for="urna15"><h5>UE2015:</h5></label>
								<input type="number" min="0" class="form-control" name="ue2015p" id="ue2015p" value="0" onkeypress="$(this).mask('0000')"  >
							</div>
						</div>
						<div class="row">
							<div class="col-md-2 ">
								<label for="urna21"><h5>UE2020:</h5></label>
								<input type="number" min="0" class="form-control" name="ue2020p" id="ue2020p" value="0"  onkeypress="$(this).mask('0000')"  >
							</div>
							<div class="col-md-2">
								<label for="urna22"><h5>UE2022:</h5></label>
								<input type="number" min="0" class="form-control" name="ue2022p" id="ue2022p"  value="0" onkeypress="$(this).mask('0000')"  >
							</div>
							<!-- <div class="col-md-2">
						...
						<div class="row">
							...
							<div class="col-md-2">
								<label for="urna22">Baterias submetidas à "barriga de aluguel":</label>

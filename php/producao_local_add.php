...
extract($_REQUEST);
	...
	// --------- ATUALIZA TABELA STATUS 	//PEGA OS VALORES ATUAIS DA TABELA STATUS		
		// $ids_local = $_SESSION['id_local'];
		// //echo $id_local;
       ...
       //print_r($data);
		...
		//------- INSERE OS VALORES FINAIS NA TABELA STATUS - UPDATE
			...
			// if($userCount[0]['total']<30){
				...
				$data	=	array(
								...
								'tbat_barriga_aluguel'=>$tbat_barriga_aluguel_v,
			...
			<div class="card-body">		
					...
					<!-- FIM CAMPOS AUX --->
						...
						<div class="col-md-3 ">
								...
								<div id="n_ciclo2" name="n_ciclo2"><h5><?=  max_ciclo() ; ?> </h5></div>
							</div>
							<div class="col-md-3 ">
								<label>Nº da OS:</label>
								<div id ="n_os2" name="n_os2" ><h5> <?= max_os_local($ids_local); ?> </h5> </div>
							</div>
							<div class="col-md-3 ">
								<label>Local:</label>
							...
							<div class="col-md-3 ">
								<label>Data:</label>
								<div id ="data" name="n_local2"  > <h5><?php echo date('d/m/Y')?> </h5> </div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
							</br> <!--- QUEBRA DE LINHA NO LAYOUT -->
								<label> <h5>Total Urnas com STE realizado no período</h5></label>
							</div>
							<div class="col-md-2">
								<label for="urna09"><h5>UE2009:</h5></label>
								<input type="number" min="0" class="form-control" name="ue2009p" id="ue2009p" value="0" onkeypress="$(this).mask('0000')" onfocusout="totalUrna()">
							</div>
							<div class="col-md-2 ">
								<label for="urna10"><h5>UE2010:</h5></label>
								<input type="number" min="0"  class="form-control" name="ue2010p" id="ue2010p" value="0"  onkeypress="$(this).mask('0000')" onfocusout="totalUrna()" >
							</div>
							<div class="col-md-2 ">
								<label for="urna11"><h5>UE2011:</h5></label>
								<input type="number" min="0"  class="form-control"  name="ue2011p" id="ue2011p" value="0" onkeypress="$(this).mask('0000')" onfocusout="totalUrna()">
							</div>
							<div class="col-md-2 ">
								<label for="urna13"><h5>UE2013:</h5></label>
								<input type="number" min="0" class="form-control" name="ue2013p" id="ue2013p" value="0" onkeypress="$(this).mask('0000')" onfocusout="totalUrna()">
							</div>
							<div class="col-md-2 ">
								<label for="urna15"><h5>UE2015:</h5></label>
								<input type="number" min="0" class="form-control" name="ue2015p" id="ue2015p" value="0" onkeypress="$(this).mask('0000')" onfocusout="totalUrna()" >
							</div>
						</div>
						<div class="row">
							<div class="col-md-2 ">
								...
								<input type="number" min="0" class="form-control" name="ue2020p" id="ue2020p" value="0"  onfocusout="totalUrna()" onkeypress="$(this).mask('0000')"  >
							</div>
							<div class="col-md-2">
								<label for="urna22"><h5>UE2022:</h5></label>
								<input type="number" min="0" class="form-control" name="ue2022p" id="ue2022p" value="0"  onfocusout="totalUrna()" value="" onkeypress="$(this).mask('0000')"  >
							</div>
							<!-- <div class="col-md-2">
						...
						<div class="row">
							...
							<div class="col-md-2 ">
								...
								<input type="number" min="0" class="form-control" name="nue_com_chamado"  id="nue_com_chamado" onkeypress="$(this).mask('0000')" value="0" required>
							</div>
							<div class="col-md-2">
								<label for="urna22">Urnas SEM chamado aberto:</label>
								<input type="number" min="0" class="form-control" name="nue_sem_chamado" id="nue_sem_chamado" onkeypress="$(this).mask('0000')" value="0" required>
							</div>
						</div>	
						</br> <!--- QUEBRA DE LINHA NO LAYOUT -->
						<div class="row">
							...
							<div class="col-md-2">
								<label for="urna22">Submetidas à "barriga de aluguel":</label>
								<input type="number" min="0" class="form-control"  value="0" name="bat_barriga_aluguel" id="bat_barriga_aluguel" onkeypress="$(this).mask('0000')" >
							</div>
							<div class="col-md-2">
								<label for="urna22">Com vazamento (em garantia):</label>
								<input type="number" min="0" class="form-control"  value="0" name="bat_vazando" id="bat_vazando" onkeypress="$(this).mask('0000')" >
							</div>
							<div class="col-md-2">
								<label for="urna22">Com oxidação (em garantia):</label>
								<input type="number" min="0" class="form-control" value="0" name="bat_oxidada"  id="bat_oxidada" onkeypress="$(this).mask('0000')" >
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">

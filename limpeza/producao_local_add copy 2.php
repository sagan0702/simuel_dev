					...
					<!-- FIM CAMPOS AUX --->
						...
						<div class="row">
							...
							<div class="col-md-2">
								...
								<input type="text" class="form-control" name="ue2022p" id="ue2022p" onfocusout="totalUrna()" value="" onkeypress="$(this).mask('0000')"  >
							</div>
							<!-- <div class="col-md-2">
						...
						<div class="row">
							...
							<div class="col-md-2">
								<label for="urna22">Baterias <br> Substituídas: </label>
								<input type="text" class="form-control" value="" name="bat_subst" id="bat_subst" onkeypress="$(this).mask('0000')" >
							</div>

							<div class="col-md-2">
								<label for="urna22">Baterias <br> Substituídas: </label>
								<input type="number" class="form-control" placeholder="0" name="bat_subst" id="bat_subst" onkeypress="$(this).mask('0000')" >
							</div>

							<div class="col-md-2">
								<label for="urna22">Baterias submetidas à "Barriga de Aluguel":</label>
								<input type="text" class="form-control"  value="" name="bat_barriga_aluguel" id="bat_barriga_aluguel" onkeypress="$(this).mask('0000')" >
							</div>	

							<div class="col-md-2">
								<label for="urna22">Com vazamento (em garantia):</label>
								<input type="text" class="form-control"  value="" name="bat_vazando" id="bat_vazando" onkeypress="$(this).mask('0000')" >
							</div>
							<div class="col-md-2">
								<label for="urna22">Com oxidação (em garantia):</label>
								<input type="text" class="form-control" value="" name="bat_oxidada"  id="bat_oxidada" onkeypress="$(this).mask('0000')" >
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">

       ...
       //print_r($data);
		...
		if(count($userData)>0){
			...
			foreach($userData as $val){
				...
				$tbat_barriga_aluguel = $val['tbat_barriga_aluguel'];
		...
		//------- somar/atualizar os valores de status com os valores da producao atual
		 ...
		 $tbat_barriga_aluguel_v= $bat_barriga_aluguel_v + $bat_barriga_aluguel;
			...
			<div class="card-body">		
					...
					<!-- FIM CAMPOS AUX --->
						...
						<div class="row">
							...
							<div class="col-md-2">
								<label for="urna22">Baterias Carregadas ("Barriga de Aluguel"):</label>
